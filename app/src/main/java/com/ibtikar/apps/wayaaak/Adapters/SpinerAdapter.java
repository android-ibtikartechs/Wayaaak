...
public class SpinerAdapter extends ArrayAdapter<LocationItem> {
    LayoutInflater flater;
    onClickListner listner;

    public SpinerAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<LocationItem> objects) {
    ...
    private View rowview(View convertView, int position, ViewGroup parent) {
        ...
        final LocationItem rowItem = getItem(position);
